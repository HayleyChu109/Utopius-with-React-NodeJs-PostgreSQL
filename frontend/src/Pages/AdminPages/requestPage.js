...
import { FinishedRequestCard,MatchedRequestCard,OpenRequestCard } from "../../Components/PrivateComponents/admin/fininshedRequestCard";
...
export default function RequestPage() {
  ...
  const dispatch = useDispatch()
   useEffect(()=>{
      dispatch(GetRequestChart( moment().subtract(7, "day").startOf("day").format("YYYY-MM-DD"),
